// Execute with: module load OpenBLAS; module load intel 
// Add flags: icpx -O2 src/cg_omp_blas.cpp -o cg_omp_blas -lopenblas -fopenmp
// Set number threads: export OMP_NUM_THREADS=8
...
void gemv(double alpha, const double * A, const double * x, double beta, double * y, size_t num_rows, size_t num_cols)
{
    ...
    // cblas_dgemv(CblasRowMajor, CblasNoTrans, num_rows, num_cols, alpha, A, num_cols, x, 1, beta, y, 1);
