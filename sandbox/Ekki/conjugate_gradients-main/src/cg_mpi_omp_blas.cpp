//
// Execute with: module load OpenMPI; module load OpenBLAS
//               mpic++ -o cg_mpi_omp_blas src/cg_mpi_omp_blas.cpp -lopenblas -fopenmp
//               export OMP_NUM_THREADS=4
//               srun -n 4 ./cg_mpi_omp_blas io/matrix.bin io/rhs.bin io/sol.bin        // up to 256 processes
//
